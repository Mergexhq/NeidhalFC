  ...
  (
    ...
    const containerStyle = useMemo(
      (): NonNullable<DiaTextMotionProps["style"]> => ({
        ...(isMulti && {
          ...
          overflow: "hidden",
          whiteSpace: "nowrap",
          verticalAlign: "bottom" as CSSProperties["verticalAlign"],
    ...
    const contentStyle = useMemo(
      (): NonNullable<DiaTextMotionProps["style"]> => ({
        ...
        ...(isMulti && { transform: contentTransform }),
    ...
    return (
      <motion.span
        ...
        className={cn(
          ...
          isMulti ? "align-bottom" : "",
          "text-inherit leading-[100%]",
          className
        )}
        ref={setRefs}
