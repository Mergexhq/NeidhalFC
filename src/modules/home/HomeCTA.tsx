    ...
    <section className="py-24 bg-[#FAF7F2] relative overflow-hidden">
      <div className="max-w-4xl mx-auto px-6 relative z-10 text-center flex flex-col items-center">
        ...
        <p className="text-[#6F6F6F] text-sm md:text-base max-w-xl mx-auto leading-relaxed mb-10 font-normal">
          Give your child the opportunity to train with licensed coaches and experience our coastal coaching pods first-hand.
        </p>

        <Link
          href="/contact"
          className="inline-flex items-center gap-2 bg-primary hover:bg-accent text-white font-sans font-bold text-xs uppercase tracking-wider px-10 py-5 rounded-xl shadow-lg transition-all duration-300 hover:scale-[1.02] cursor-pointer group"
        >
