...
export const TestimonialBoard: React.FC = () => {
  ...
  return (
    <section className="py-24 md:py-32 relative overflow-hidden bg-primary text-white border-t border-white/5 min-h-[70vh] flex flex-col items-center justify-center">
      {/* Background visual image matching reference */}
      <div className="absolute inset-0 z-0">
        <Image
          src="/neidhal testimonial.png"
