        ...
        >
          {CARDS.map((card, idx) => (
            <motion.div
              ...
              className={`relative flex flex-col justify-between pt-3 pb-8 px-6 md:pt-4 md:pb-10 md:px-8 min-h-[500px] md:min-h-[660px] transition-colors duration-500 group border-b md:border-b-0 overflow-hidden ${
